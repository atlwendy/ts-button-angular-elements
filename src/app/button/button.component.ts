...
/**
 * Define the allowed {@link ButtonComponent} action types
 */
...
/**
 * Define the allowed {@link ButtonComponent} format types
 */
...
export class ButtonComponent implements OnInit, OnDestroy {
  ...
  public set collapsed(value: boolean) {
    ...
    if (!isBoolean(value) && value && isDevMode()) {
      console.warn(`ButtonComponent: "collapsed" value is not a boolean. ` +
  ...
  public set format(value: TsButtonFormatTypes) {
    ...
    if (tsButtonFormatTypesArray.indexOf(value) < 0 && isDevMode()) {
      console.warn(`ButtonComponent: "${value}" is not an allowed format. ` +
  ...
  public set isDisabled(value: boolean) {
    /* istanbul ignore if */
    if (!isBoolean(value) && value && isDevMode()) {
      console.warn(`ButtonComponent: "isDisabled" value is not a boolean. ` +
        `String values of 'true' and 'false' will no longer be coerced to a true boolean with the next release.`);
    }
  ...
  public set showProgress(value: boolean) {
    /* istanbul ignore if */
    if (!isBoolean(value) && value && isDevMode()) {
      console.warn(`ButtonComponent: "showProgress" value is not a boolean. ` +
        `String values of 'true' and 'false' will no longer be coerced to a true boolean with the next release.`);
    }
  ...
  public set theme(value: any) {
    ...
    //   console.warn(`ButtonComponent: "${value}" is not an allowed theme. ` +
    //     `See any for available options.`);
    //   return;
    // }
